            ...
            <el-col :md="12">
                <div class="source">
                    <el-form label-position="left" class="server_info">
                        ...
                        <el-form-item label="子域主机">
                          <span>{{ subdomain_host }}</span>
                        </el-form-item>
                        <el-form-item label="最大池数量">
                          <span>{{ max_pool_count }}</span>
                        </el-form-item>
                        <el-form-item label="最大客户端连接数">
